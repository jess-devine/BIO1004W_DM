...
Both variables (incubation period and chick mass) do not follow a normal distribution based on the Shapiro-Wilk test and the QQ plots but Chickmass is far closer to normal. 
